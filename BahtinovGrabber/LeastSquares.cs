...
public static class LeastSquares
{
        ...
        ref double intercept)
    {
        ...
        var rotatedSum1 = AP.Math.Sqr(cosAngle) * numPoints + AP.Math.Sqr(sinAngle) * sumXSquared -
                          2.0 * sinAngle * cosAngle * sumX;
        var rotatedSum2 = AP.Math.Sqr(sinAngle) * numPoints + AP.Math.Sqr(cosAngle) * sumXSquared +
                          2.0 * sinAngle * cosAngle * sumX;

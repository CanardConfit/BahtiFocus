...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusDockables {
    ...
    public class BahtifocusDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public BahtifocusDockable(
            ...
            dict.Source = new Uri("CanardConfit.NINA.Bahtifocus;component/BahtifocusDockables/BahtifocusDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["CanardConfit.NINA.Bahtifocus_AltitudeSVG"];

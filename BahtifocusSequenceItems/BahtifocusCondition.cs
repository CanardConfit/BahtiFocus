...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusTestCategory {
    ...
    public class BahtifocusCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new BahtifocusCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(BahtifocusCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}
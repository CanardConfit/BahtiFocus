...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "BahtiFocus")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class BahtifocusInstruction : SequenceItem {
        /// <summary>
        ...
        public BahtifocusInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public BahtifocusInstruction(BahtifocusInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new BahtifocusInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(BahtifocusInstruction)}, Text: {Text}";
        }
    }
}
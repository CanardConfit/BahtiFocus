...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusTestCategory {
    ...
    public class BahtifocusTrigger : SequenceTrigger {
        /// <summary>
        ...
        public BahtifocusTrigger() {
        }

        public override object Clone() {
            return new BahtifocusTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(BahtifocusTrigger)}";
        }
    }
}
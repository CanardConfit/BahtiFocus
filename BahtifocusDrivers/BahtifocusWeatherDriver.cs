...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusDrivers {
    ...
    /// </summary>
    public class BahtifocusWeatherDriver : BaseINPC, IWeatherData {
        public BahtifocusWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Bahtifocus Weather Data ({deviceId})";
        ...
        public string Category => "Bahtifocus Weather Driver";

...
namespace CanardConfit.NINA.Bahtifocus.BahtifocusDrivers {
    /// <summary>
    ...
    public class BahtifocusWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public BahtifocusWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "Bahtifocus";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new BahtifocusWeatherDriver("MyUniqueId", "MyDeviceId"));
